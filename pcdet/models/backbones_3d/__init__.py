...
from .spconv_backbone_voxelnext_deBEV_effv2next4 import VoxelResBackBone8xVoxelNeXtEffv2Next4
...
__all__ = {
    ...
    'VoxelResBackBone8xVoxelNeXtEffv2Next4': VoxelResBackBone8xVoxelNeXtEffv2Next4,
